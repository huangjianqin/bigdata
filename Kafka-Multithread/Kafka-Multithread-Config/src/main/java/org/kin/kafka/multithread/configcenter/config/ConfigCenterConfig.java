...
public class ConfigCenterConfig {
    ...
    static {
        ...
        CONFIG2FORMATOR.put(CONFIG_STOREMANAGER_SERVER_HOST, "\\d\\.\\d\\.\\d\\.\\d");
        CONFIG2FORMATOR.put(CONFIG_STOREMANAGER_SERVER_PORT, "\\d*");
        CONFIG2FORMATOR.put(DIAMONDMASTERPROTOCOL_PORT, "\\d*");
        CONFIG2FORMATOR.put(ADMINPROTOCOL_PORT, "\\d*");
    }
}
